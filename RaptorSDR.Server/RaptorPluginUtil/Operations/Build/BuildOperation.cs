...
namespace RaptorPluginUtil.Operations.Build
{
    public static class BuildOperation
    {
        public static int Handle(RaptorParams args)
        {
            ...
            using(ZipArchive archive = new ZipArchive(fs, ZipArchiveMode.Create))
            {
                ...
                RaptorBuildManifest manifest = new RaptorBuildManifest
                {
                    ...
                    sdk_version = Program.VERSION_CODE
                };

                //Build bits
                if (!BuildServer(cfg, archive, manifest.items))
                    return -1;
        ...
        private static bool BuildServer(RaptorConfig cfg, ZipArchive archive, List<RaptorBuildManifestItem> manifest)
        {
            //Write the autogenerated file
            CSharpFileUtil.WriteAutogeneratedFile(cfg);
