...
{
    public delegate void IRaptorEndpoint_ClientStatusChanged(IRaptorEndpoint endpoint, IRaptorEndpointClient client, IRaptorSession session);
    public delegate void IRaptorEndpoint_MessageEventArgs(IRaptorEndpoint endpoint, IRaptorEndpointClient client, JObject payload);
